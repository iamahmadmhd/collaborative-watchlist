...
export function MovieCard({ movie, badge }: { movie: MovieSummary; badge?: ReactNode }) {
    ...
    return (
        <div className='flex flex-col justify-between gap-2'>
            {/* FR-DISC-4's entry point. `badge` (Save, a <button>) stays a sibling
                outside the Link rather than nested inside it — an interactive
                control inside an <a> is invalid HTML and would double-fire on
